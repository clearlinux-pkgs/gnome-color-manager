...
Version  : 3.28.0
Release  : 6
URL      : https://download.gnome.org/sources/gnome-color-manager/3.28/gnome-color-manager-3.28.0.tar.xz
Source0  : https://download.gnome.org/sources/gnome-color-manager/3.28/gnome-color-manager-3.28.0.tar.xz
Summary  : No detailed summary available
Group    : Development/Tools
License  : GPL-2.0
Requires: gnome-color-manager-bin
Requires: gnome-color-manager-data
Requires: gnome-color-manager-doc
...
%prep
%setup -q -n gnome-color-manager-3.28.0
...
export LANG=C
export SOURCE_DATE_EPOCH=1522197693
