...
Source0  : https://download.gnome.org/sources/gnome-color-manager/3.30/gnome-color-manager-3.30.0.tar.xz
Summary  : No detailed summary available
Group    : Development/Tools
License  : GPL-2.0
Requires: gnome-color-manager-bin
Requires: gnome-color-manager-data
Requires: gnome-color-manager-license
Requires: gnome-color-manager-locales
...
%prep
%setup -q -n gnome-color-manager-3.30.0
...
%install
mkdir -p %{buildroot}/usr/share/doc/gnome-color-manager
cp COPYING %{buildroot}/usr/share/doc/gnome-color-manager/COPYING
...
%files license
%defattr(-,root,root,-)
/usr/share/doc/gnome-color-manager/COPYING
